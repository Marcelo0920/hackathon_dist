            ...
            {user.rolName === "admin" ? (
              <>
                ...
                <li>
                  ...
                  >
                    <DocumentTextIcon className="h-5 w-5" /> Tipos de reclamos
                  </NavLink>
                </li>
                <li>
                  <NavLink
                    to={`${PrivateRoutes.PRIVATE}${PrivateRoutes.ROLES}`}
                    className={({ isActive }) =>
                      isActive
                        ? "flex items-center mb-1 gap-4 py-2 px-4 rounded-lg bg-green-700 text-white"
                        : "flex items-center mb-1 gap-4 hover:bg-gray-200 transition-colors py-2 px-4 rounded-lg"
                  ...
                  >
                    <Square3Stack3DIcon className="h-5 w-5" /> Roles
                  </NavLink>
                </li>
                <li>
                  <NavLink
                    to={`${PrivateRoutes.PRIVATE}${PrivateRoutes.ZONAS}`}
                    className={({ isActive }) =>
                      isActive
                        ? "flex items-center mb-1 gap-4 py-2 px-4 rounded-lg bg-green-700 text-white"
                        : "flex items-center mb-1 gap-4 hover:bg-gray-200 transition-colors py-2 px-4 rounded-lg"
                  ...
                  >
                    <MapPinIcon className="h-5 w-5" /> Zonas
                  </NavLink>
                </li>
                <li>
                  <NavLink
                ...
                <li>
                  ...
                  >
                    <FolderIcon className="h-5 w-5" /> Reclamos
                  </NavLink>
                </li>
                <li>
                  <NavLink
                    to={`${PrivateRoutes.PRIVATE}${PrivateRoutes.REQUERIMIENTOS}`}
                    className={({ isActive }) =>
                      isActive
                        ? "flex items-center mb-1 gap-4 py-2 px-4 rounded-lg bg-green-700 text-white"
                        : "flex items-center mb-1 gap-4 hover:bg-gray-200 transition-colors py-2 px-4 rounded-lg"
                  ...
                  >
                    <DocumentPlusIcon className="h-5 w-5" /> Requerimientos
                  </NavLink>
                </li>
                <li>
                  <NavLink
                  ...
                  >
                    <BellAlertIcon className="h-5 w-5" /> Notificaciones
                  </NavLink>
                </li>
              </>
            ) : null}
