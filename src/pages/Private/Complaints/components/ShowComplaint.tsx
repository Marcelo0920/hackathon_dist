...
function ShowComplaint() {
  ...
  return (
    <div className="card flex-shrink-0 w-full shadow-2xl  mt-16">
      <Toaster />
      <ul className="menu bg-white lg:menu-horizontal rounded-box p-10 pb-0">
        <li className="hover:fill-green-700">
          <Link to={`${PrivateRoutes.PRIVATE}${PrivateRoutes.COMPLAINTS}`}>
            ...
            <p className="hover:text-green-500">Atras</p>
          </Link>
        </li>
        <li>
          {/* part of modal */}
          <label onClick={() => setWithStatus(false)} htmlFor="my_modal_7">
            <p className="hover:text-green-500">Agregar observación</p>
          </label>
        </li>
        <li>
          <label onClick={() => setWithStatus(true)} htmlFor="my_modal_7">
            <p className="hover:text-green-500">Cambiar de estado</p>
          </label>
        </li>
        <li>
          <Link
          ...
          >
            <p className="hover:text-green-500">Ver en mapa</p>
          </Link>
        </li>
      </ul>
      ...
      <div className="p-10">
        ...
        <div className="px-4 sm:px-0 mt-4">
          ...
          <div className="flex justify-start w-full py-2 gap-2">
            <a href="#item1" className="btn btn-xs bg-green-700">
              1
            </a>
            {complaintFound && complaintFound.photos.length > 1 && (
              <a href="#item2" className="btn btn-xs bg-green-700">
                2
              </a>
            )}
          </div>
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
              ...
              <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                <div className="badge badge-neutral bg-orange-500">
                  <p className="text-white">{complaintFound?.state}</p>
                </div>
              </dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
