...
function OfficialsList() {
  ...
  return (
    <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-lg">
      ...
      <div className="hidden md:grid grid-cols-1 md:grid-cols-6 gap-4 mb-4 px-3 py-4 border-b border-gray-200 text-gray-900">
        <h5>ID</h5>
        <h5>Nombre</h5>
        <h5>Telefono</h5>
        <h5>Zona</h5>
      ...
      {officialsPagination().map((official, index) => (
        <div
          key={official._id}
        ...
        >
          ...
          <div>
            ...
            <p className="break-words">
              {index % 3 === 0 ? "Zona Sur" : "Zona Norte"}
            </p>
          </div>

          <div style={{ color: index % 2 === 0 ? "green" : "red" }}>
            {index % 2 === 0 ? "Disponible" : "No Disponible"}
          </div>
