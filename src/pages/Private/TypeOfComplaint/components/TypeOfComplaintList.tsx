  ...
  return (
    <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-lg">
        ...
        >
          ...
          <div>
            ...
            {typeOfComplaint.tags.map((tag) => (
              <div
                key={tag}
                className="badge badge-neutral mr-1 mb-1 bg-green-700 text-white"
              >
                {tag}
              </div>
            ))}
      ...
      <div className="join ">
        <button
          onClick={prevPage}
          className="join-item btn bg-green-700 text-white"
        >
          «
        </button>
        <button className="join-item btn bg-green-700 text-white">
